...
<head>
    ...
    <title>Dashboard Home Operator</title>
    <!-- Bootstrap core CSS -->
...
<body>
    <!-- Awal Kontainer -->
    <div class="container">
        <div class="jumbotron bg-success text-white mb-3 p-3">
